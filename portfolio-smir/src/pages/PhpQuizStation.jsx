// src/pages/PhpQuizStation.jsx
import React, { useState, useEffect, useRef, useCallback } from "react";
import { useNavigate } from "react-router-dom";
import { 
  Zap, Brain, Code2, Trophy, Clock 
} from "lucide-react";
import { PHP_QUESTIONS, DIFFICULTY_META } from "../components/stations/php/phpQuestions";
...
import { phpQuizHistory } from "../components/stations/shared/quizHistory";
...
export default function PhpQuizStation() {
  ...
  const handleNext = () => {
    ...
    if (nextIndex >= total) {
      ...
      phpQuizHistory.addResult(result);
      loadStats();
    } else {
